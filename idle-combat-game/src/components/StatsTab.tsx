...
const StatsTab: React.FC<StatsTabProps> = ({ playerStats, totalLevels }) => {
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="rounded-2xl border border-teal-500/40 bg-gradient-to-br from-teal-500/20 via-transparent to-teal-500/10 p-7 sm:p-8 text-white shadow-[0_25px_60px_-35px_rgba(42,157,143,0.45)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {STAT_ORDER.map((statId) => {
          ...
          return (
            <div
              key={statId}
              className="group rounded-2xl border border-charcoal-200/30 bg-charcoal-200/15 p-5 sm:p-6 backdrop-blur-sm transition-all duration-200 hover:border-teal-500/40 hover:bg-charcoal-200/25"
            >
              <div className="flex items-center gap-4">
                <div className="rounded-xl bg-teal-500/20 p-3 text-teal-600 group-hover:bg-teal-500/30">
