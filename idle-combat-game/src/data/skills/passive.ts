...
export const ArcaneStudies: SkillDefinition = {
  ...
  icon: GiSpellBook,
  effects: [{ type: "traitJobExp", trait: TraitValue.Magical, value: 0.20 }], // +20% per level
};
...
export const PhysicalTraining: SkillDefinition = {
  ...
  icon: GiSwordsPower,
  effects: [{ type: "traitJobExp", trait: TraitValue.Physical, value: 0.20 }], // +20% per level
};
...
export const SwiftLearning: SkillDefinition = {
  ...
  icon: GiRunningNinja,
  effects: [{ type: "traitJobExp", trait: TraitValue.Swift, value: 0.20 }], // +20% per level
};
...
export const Dedication: SkillDefinition = {
  ...
  icon: GiBrain,
  effects: [{ type: "skillExp", value: 0.40 }], // +40% per level
